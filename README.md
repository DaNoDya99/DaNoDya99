...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&color=36BCF7&size=30&lines=Hey!+I'm+Danodya!;AI%2FML+Enthusiast;%26+a+Software+Developer;A+Lifelong+Learner)](https://git.io/typing-svg)

<table align="center">
<tr border="none">
<td width="50%" align="left">
  
<br> <!-- Simulating padding -->

👩‍💻 I am a Full Stack Developer and Machine Learning Enthusiast with a huge love for Python, PyToech, React.js, Vue.js, Node.js, Spring Boot, RDBMS, REST API and Data Visualization. 

- 💻 Computer Scientist exploring cutting-edge technologies. 
- 🚀 Developing innovative AI/ML and software solutions.
- 🧠 Continuously learning new frameworks and programming languages.
- 📝 Writing technical blogs at [Medium](https://medium.com/@danodyasupun7/integrating-auto-encoders-for-effective-dimensionality-reduction-in-image-classification-486e40a0ec26)
- 🌍 Visit my [Portfolio](https://portfolio-f97a4.web.app) for more details about my work and journey.
